...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="container">		
		...
		<?php
			...
			$objCommande->stpi_affJsAddPublic();
				...
				if ($objCommandeSession = $objCommandeSession->stpi_getObjCommandeSessionFromSession())
				{
					...
					if ($arrObjAdresseSession = $objCommandeSession->stpi_getArrObjAdresseSession())
					{
						if (isset($arrObjAdresseSession[1]) && isset($arrObjAdresseSession[2]))
						{
							...
							print("</table>\n");
							print("<p><a href=\"checkout2.php?l=" . LG . "\" >" . $objTexte->stpi_getArrTxt("backto2") . "</a><br/>");
							print("<a href=\"checkout3.php?l=" . LG . "\" >" . $objTexte->stpi_getArrTxt("backto3") . "</a></p>");
						}	
					}
					...
					if ($arrObjCommandeSousItemSession = $objCommandeSession->stpi_getArrObjCommandeSousItemSession())
					{
						if(!empty($arrObjCommandeSousItemSession))
						{
							...
							print("<span id=\"stpi_addCommande\" ></span>\n");
							print("<br/><br/>\n");
							print("<a href=\"shop.php?l=" . LG . "\" >" . $objTexte->stpi_getArrTxt("backtoshop") . "</a> - <input type=\"button\" id=\"stpi_addCommandeButton\" onclick=\"stpi_addCommande()\" value=\"" . $objTexte->stpi_getArrTxt("buttonplaceorder") . "\" />\n");
							print("</div><br/>\n");
