...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php				
		...
		if ($objTypeEvent->stpi_setNbID($_GET["nbTypeEventID"]))
		{
			if ($objTypeEvent->stpi_setArrObjTypeEventLgFromBdd())
			{
				print("<input type=\"hidden\" id=\"nbTypeEventID\" value=\"" . $objTypeEvent->stpi_getNbID() . "\" />\n");
				$objTypeEvent->stpi_affJsDelete();
				$objTypeEvent->stpi_affJsEdit();
				$objTypeEvent->stpi_affEdit();
			}
		}			
	?>		
	</div>
