...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php
		...
		print("<h1>" . $objTexte->stpi_getArrTxt("users") . "</h1>\n");
		$objSTPIAdminUser->stpi_affJsSearch();
		$objSTPIAdminUser->stpi_affSearch();
		$objSTPIAdminUser->stpi_affJsAdd();
		$objSTPIAdminUser->stpi_affAdd();
	?>
	</div>	
	</body>
</html>