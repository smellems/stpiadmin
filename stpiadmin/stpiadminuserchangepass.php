...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php
		...
		$objSTPIAdminUser->stpi_affJsPassChange();
		...
		if (!$objSTPIAdminUser->stpi_setNbID($objUser->stpi_getNbID()))
		{
			$gonogo = false;
		}
		...
		if ($_GET["op"] == "save")
		{
			if (!$objSTPIAdminUser->stpi_chkStrOldPassword($_POST["strOldPassword"]))
			{
				$gonogo = false;
			}					
		}
		...
		if ($_GET["op"] == "save")
		{
			if (!$objSTPIAdminUser->stpi_chkStrPassword($_POST["strPassword"]))
			{
				$gonogo = false;
			}
		}
		...
		{
			$objSTPIAdminUser->stpi_setStrPassword($_POST["strPassword"]);
			
			if ($objSTPIAdminUser->stpi_changePassword())
			{
