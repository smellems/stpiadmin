...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="container">		
		...
		<?php
			...
			print("<h2>" . $objTexte->stpi_getArrTxt("checkout5") . "</h2>\n");			
			
			print("<p>" . $objTexte->stpi_getArrTxt("thank") . "</p><br/>");
			
			if (isset($_SESSION["stpiCommandeEmailMessage"]))
			{
				print($_SESSION["stpiCommandeEmailMessage"] . "<br/>");
				unset($_SESSION["stpiCommandeEmailMessage"]);
			}
		?>
