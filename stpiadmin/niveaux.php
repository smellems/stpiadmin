<?php
	...
	$objTexte = new clstexte("./texte/niveau");
	...
	<body>
		...
		<div id="droite">
			<?php
				...
				$objNiveau->stpi_affJsSelectNiveau();			
				$objNiveau->stpi_affJsEdit();
				$objNiveau->stpi_affJsAdd();
				$objNiveau->stpi_affJsDelete();
				
				print("<h1>" . $objTexte->stpi_getArrTxt("titre1") . "</h1>\n");
				
				print("<h2>" . $objTexte->stpi_getArrTxt("titre2") . "</h2>\n");
								
				$objNiveau->stpi_affSelectNiveau();
								
				print("<h2>" . $objTexte->stpi_getArrTxt("titre3") . "</h2>\n");
				
				$objNiveau->stpi_affAdd();					
			?>
