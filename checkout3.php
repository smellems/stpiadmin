...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="container">		
		...
		<?php
			...
			$objAdresse->stpi_affJsAdresseLivraisonToCommande();
			...
			if (isset($_SESSION["stpiObjCommandeSession"]))
			{
				if ($objCommandeSession = $objCommandeSession->stpi_getObjCommandeSessionFromSession())
				{
					...
					print("<span id=\"stpi_AddAdresseLivraisonToCommande\"></span><br/>\n");
					print("<a href=\"checkout2.php?l=" . LG . "\" >" . $objTexte->stpi_getArrTxt("backto2") . "</a> - <input id=\"stpi_AddAdresseLivraisonToCommandeButton\" type=\"button\" onclick=\"stpi_AddAdresseLivraisonToCommande()\" value=\"" . $objTexte->stpi_getArrTxt("continue") . "\"/><br/>\n");
					print("</td>\n");
					print("</tr>\n");
