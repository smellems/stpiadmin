...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="container">		
		...
		<?php
			...
			$objAdresse->stpi_affJsAdresseFacturationToCommandeRegistre();
			...
			if (isset($_SESSION["stpiObjCommandeRegistreSession"]))
			{
				if ($objCommandeSession = $objCommandeSession->stpi_getObjCommandeRegistreSessionFromSession())
				{
					...
					print("</td>\n");
					print("<td width=\"80%\" style=\"text-align: left; vertical-align: top;\" >\n");
					...
					print("<span id=\"stpi_AddAdresseFacturationToCommandeRegistre\"></span><br/>\n");
					print("<a href=\"checkout1.php?l=" . LG . "\" >" . $objTexte->stpi_getArrTxt("backto1") . "</a> - <input id=\"stpi_AddAdresseFacturationToCommandeRegistreButton\" type=\"button\" onclick=\"stpi_AddAdresseFacturationToCommandeRegistre()\" value=\"" . $objTexte->stpi_getArrTxt("continue") . "\"/><br/>\n");
					print("</td>\n");
					print("</tr>\n");
