...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php				
		...
		if ($objTypeCommande->stpi_setNbID($_GET["nbTypeCommandeID"]))
		{
			if ($objTypeCommande->stpi_setArrObjTypeCommandeLgFromBdd())
			{
				print("<input type=\"hidden\" id=\"nbTypeCommandeID\" value=\"" . $objTypeCommande->stpi_getNbID() . "\" />\n");
				$objTypeCommande->stpi_affJsDelete();
				$objTypeCommande->stpi_affJsEdit();
				$objTypeCommande->stpi_affEdit();
			}
		}			
	?>		
	</div>
